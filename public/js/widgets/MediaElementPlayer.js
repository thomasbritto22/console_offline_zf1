...
mejs.MediaElementDefaults = {
	...
	pluginPath: mejs.Utility.getScriptPath(['/js/widgets/MediaElementPlayer.js']),
	// name of flash file
	flashName: '/videos/catalyst-flashmediaelement.swf',
	...
	silverlightName: '/videos/catalyst-silverlightmediaelement.xap',
...
mejs.HtmlMediaElementShim = {
    ...
    if (options.customError) {
      ...
      errorContainer.innerHTML = (poster !== '') ?
        '<a href="' + playback.url + '"><img src="' + poster + '" width="100%" height="auto" /></a>' :
	...
	mejs.MediaElementPlayer.prototype = {
		...
		setPoster: function(url) {
			...
			if (posterImg.length === 0) {
				posterImg = $('<img width="100%" height="auto" />').appendTo(posterDiv);
			}

			posterImg.attr('src', url);
			// uncomment the next line if we want the background image to be the poster
